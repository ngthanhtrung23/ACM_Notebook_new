...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_2_b_basic_segment_intersect.test.cpp\"\
    ...
    }\n#line 5 \"Geometry/tests/aizu_cgl_2_b_basic_segment_intersect.test.cpp\"\n\n\
    void solve() {\n    int q; cin >> q;\n    while (q--) {\n        Point a, b; cin\
...
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_2_b_basic_segment_intersect.test.cpp
- /verify/Geometry/tests/aizu_cgl_2_b_basic_segment_intersect.test.cpp.html
