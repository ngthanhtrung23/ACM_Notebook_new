...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_7_f_circle_tangent_points.test.cpp\"\
    \n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\
    \n\n// Given point p and circle c. p is outside c. Find all tangents and print\
    \ tangent points on c.\n\n#line 1 \"template.h\"\n#include <bits/stdc++.h>\nusing\
    ...
    \ 8 \"Geometry/tests/aizu_cgl_7_f_circle_tangent_points.test.cpp\"\n\n#define\
    \ ERROR 1e-6\n\nvoid solve() {\n    cout << (fixed) << setprecision(10);\n   \
    \ Point p;\n    Circle c;\n    cin >> p >> c;\n    auto ls = tangents(Circle(p,\
    \ 0.0), c);\n    vector<Point> ps;\n    for (auto l : ls) {\n        auto cur\
    \ = intersection(l, c);\n        assert(!cur.empty());\n        ps.insert(ps.end(),\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/aizu_cgl_7_f_circle_tangent_points.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_7_f_circle_tangent_points.test.cpp
- /verify/Geometry/tests/aizu_cgl_7_f_circle_tangent_points.test.cpp.html
