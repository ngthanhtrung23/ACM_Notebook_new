...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_3_b_polygon_is_convex.test.cpp\"\
    ...
    // S = I + B/2 - 1\n#line 6 \"Geometry/tests/aizu_cgl_3_b_polygon_is_convex.test.cpp\"\
    \n\nvoid solve() {\n    int n; cin >> n;\n    Polygon g(n);\n    for (auto& p\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/aizu_cgl_3_b_polygon_is_convex.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_3_b_polygon_is_convex.test.cpp
- /verify/Geometry/tests/aizu_cgl_3_b_polygon_is_convex.test.cpp.html
