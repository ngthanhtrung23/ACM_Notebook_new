...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_7_g_circle_circle_tangent_points.test.cpp\"\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/aizu_cgl_7_g_circle_circle_tangent_points.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/aizu_cgl_7_g_circle_circle_tangent_points.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_7_g_circle_circle_tangent_points.test.cpp
- /verify/Geometry/tests/aizu_cgl_7_g_circle_circle_tangent_points.test.cpp.html
