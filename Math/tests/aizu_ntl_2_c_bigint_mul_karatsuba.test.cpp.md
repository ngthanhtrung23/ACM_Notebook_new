...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/aizu_ntl_2_c_bigint_mul_karatsuba.test.cpp\"\n\
    ...
    \        }\n\n        res.trim();\n        return res / norm;\n    }\n};\n// }}}\n\
    #line 5 \"Math/tests/aizu_ntl_2_c_bigint_mul_karatsuba.test.cpp\"\n\nvoid solve()\
  ...
  verifiedWith: []
documentation_of: Math/tests/aizu_ntl_2_c_bigint_mul_karatsuba.test.cpp
layout: document
redirect_from:
- /verify/Math/tests/aizu_ntl_2_c_bigint_mul_karatsuba.test.cpp
- /verify/Math/tests/aizu_ntl_2_c_bigint_mul_karatsuba.test.cpp.html
