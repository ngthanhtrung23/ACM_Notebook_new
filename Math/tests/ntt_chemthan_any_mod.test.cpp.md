...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/ntt_chemthan_any_mod.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/convolution_mod_1000000007\"\n\n#include <bits/stdc++.h>\n\
  ...
  verifiedWith: []
documentation_of: Math/tests/ntt_chemthan_any_mod.test.cpp
layout: document
redirect_from:
- /verify/Math/tests/ntt_chemthan_any_mod.test.cpp
- /verify/Math/tests/ntt_chemthan_any_mod.test.cpp.html
