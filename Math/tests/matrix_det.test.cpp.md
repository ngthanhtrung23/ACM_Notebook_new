...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/matrix_det.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_det\"\
  ...
  requiredBy: []
  timestamp: '2022-01-06 13:44:43+08:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: Math/tests/matrix_det.test.cpp
layout: document
redirect_from:
- /verify/Math/tests/matrix_det.test.cpp
- /verify/Math/tests/matrix_det.test.cpp.html
