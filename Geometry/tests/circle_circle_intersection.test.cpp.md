...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/circle_circle_intersection.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E\"\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/circle_circle_intersection.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/circle_circle_intersection.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/circle_circle_intersection.test.cpp
- /verify/Geometry/tests/circle_circle_intersection.test.cpp.html
