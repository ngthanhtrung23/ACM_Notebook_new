...
data:
  ...
  bundledCode: "#line 1 \"DataStructure/test/hld_edge_aizu.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_D\"\n\n#line\
    \ 1 \"template.h\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n#define\
    ...
    \            dfs_hld(v);\n        }\n        out[u] = dfs_number;\n    }\n};\n\
    #line 6 \"DataStructure/test/hld_edge_aizu.test.cpp\"\n\nusing ll = long long;\n\
...
layout: document
redirect_from:
- /verify/DataStructure/test/hld_edge_aizu.test.cpp
- /verify/DataStructure/test/hld_edge_aizu.test.cpp.html
