...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/bigint_mul_karatsuba.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_C\"\n\n#line\
    \ 1 \"template.h\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n#define\
    ...
    \        }\n\n        res.trim();\n        return res / norm;\n    }\n};\n#line\
    \ 5 \"Math/tests/bigint_mul_karatsuba.test.cpp\"\n\nvoid solve() {\n    BigInt\
  ...
  verifiedWith: []
documentation_of: Math/tests/bigint_mul_karatsuba.test.cpp
layout: document
redirect_from:
- /verify/Math/tests/bigint_mul_karatsuba.test.cpp
- /verify/Math/tests/bigint_mul_karatsuba.test.cpp.html
