...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/cicle_tangents.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_A\"\n\n//\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/cicle_tangents.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/cicle_tangents.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/cicle_tangents.test.cpp
- /verify/Geometry/tests/cicle_tangents.test.cpp.html
