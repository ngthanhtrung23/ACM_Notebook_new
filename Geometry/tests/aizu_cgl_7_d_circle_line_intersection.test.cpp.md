...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_7_d_circle_line_intersection.test.cpp\"\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/aizu_cgl_7_d_circle_line_intersection.test.cpp\"\
    \n\n#define ERROR 1e-6\n\nvoid solve() {\n    Circle c; cin >> c;\n    int q;\
    \ cin >> q;\n    cout << (fixed) << setprecision(10);\n    while (q--) {\n   \
    \     Point a, b; cin >> a >> b;\n        Line l(a, b);\n        auto ps = intersection(l,\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/aizu_cgl_7_d_circle_line_intersection.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_7_d_circle_line_intersection.test.cpp
- /verify/Geometry/tests/aizu_cgl_7_d_circle_line_intersection.test.cpp.html
