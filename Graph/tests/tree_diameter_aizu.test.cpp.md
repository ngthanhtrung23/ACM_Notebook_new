...
data:
  ...
  bundledCode: "#line 1 \"Graph/tests/tree_diameter_aizu.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_A\"\n\n#line\
    \ 1 \"template.h\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n#define\
    ...
    \ return {dist[s], path};\n}\n#line 5 \"Graph/tests/tree_diameter_aizu.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: Graph/tests/tree_diameter_aizu.test.cpp
layout: document
redirect_from:
- /verify/Graph/tests/tree_diameter_aizu.test.cpp
- /verify/Graph/tests/tree_diameter_aizu.test.cpp.html
