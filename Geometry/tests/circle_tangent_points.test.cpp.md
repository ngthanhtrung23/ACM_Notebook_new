...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/circle_tangent_points.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/circle_tangent_points.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/circle_tangent_points.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/circle_tangent_points.test.cpp
- /verify/Geometry/tests/circle_tangent_points.test.cpp.html
