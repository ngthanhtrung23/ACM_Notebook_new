...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/polygon_convex_hull.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A\"\n\n#line\
    \ 1 \"template.h\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n#define\
    ...
    // S = I + B/2 - 1\n#line 6 \"Geometry/tests/polygon_convex_hull.test.cpp\"\n\n\
    void solve() {\n    int n; cin >> n;\n    Polygon g(n);\n    for (auto& p : g)\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/polygon_convex_hull.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/polygon_convex_hull.test.cpp
- /verify/Geometry/tests/polygon_convex_hull.test.cpp.html
