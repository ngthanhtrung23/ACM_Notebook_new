...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_4_c_polygon_convex_cut.test.cpp\"\
    ...
    // S = I + B/2 - 1\n#line 6 \"Geometry/tests/aizu_cgl_4_c_polygon_convex_cut.test.cpp\"\
    \n\n#define ERROR 1e-6\n\nvoid solve() {\n    int n; cin >> n;\n    Polygon p(n);\n\
  ...
  verifiedWith: []
documentation_of: Geometry/tests/aizu_cgl_4_c_polygon_convex_cut.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_4_c_polygon_convex_cut.test.cpp
- /verify/Geometry/tests/aizu_cgl_4_c_polygon_convex_cut.test.cpp.html
