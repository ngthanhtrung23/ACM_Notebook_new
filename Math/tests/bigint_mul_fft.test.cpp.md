...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/bigint_mul_fft.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_F\"\n\n#line 1\
    \ \"template.h\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n#define FOR(i,a,b)\
    ...
    \        }\n\n        res.trim();\n        return res / norm;\n    }\n};\n#line\
    \ 5 \"Math/tests/bigint_mul_fft.test.cpp\"\n\nvoid solve() {\n    BigInt a, b;\
    \ cin >> a >> b;\n    cout << a * b << endl;\n}\n"
...
layout: document
redirect_from:
- /verify/Math/tests/bigint_mul_fft.test.cpp
- /verify/Math/tests/bigint_mul_fft.test.cpp.html
