...
data:
  ...
  bundledCode: "#line 1 \"DataStructure/test/aizu_dsl_2_h_segment_tree_rangeaddmin.test.cpp\"\
    ...
    \ + f.add };\n        }\n        return f;\n    }\n    static F id() {\n     \
    \   return F { NOT_SET, 0 };\n    }\n};\n#line 5 \"DataStructure/test/aizu_dsl_2_h_segment_tree_rangeaddmin.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: DataStructure/test/aizu_dsl_2_h_segment_tree_rangeaddmin.test.cpp
layout: document
redirect_from:
- /verify/DataStructure/test/aizu_dsl_2_h_segment_tree_rangeaddmin.test.cpp
- /verify/DataStructure/test/aizu_dsl_2_h_segment_tree_rangeaddmin.test.cpp.html
