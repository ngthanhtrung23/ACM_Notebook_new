...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/aizu_cgl_3_c_polygon_in_polygon.test.cpp\"\
    ...
    // S = I + B/2 - 1\n#line 6 \"Geometry/tests/aizu_cgl_3_c_polygon_in_polygon.test.cpp\"\
    \n\nvoid solve() {\n    int n; cin >> n;\n    Polygon g(n);\n    for (auto& p\
    \ : g) cin >> p;\n\n    int q; cin >> q;\n    while (q--) {\n        Point p;\
...
layout: document
redirect_from:
- /verify/Geometry/tests/aizu_cgl_3_c_polygon_in_polygon.test.cpp
- /verify/Geometry/tests/aizu_cgl_3_c_polygon_in_polygon.test.cpp.html
