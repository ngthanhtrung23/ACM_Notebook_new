...
data:
  ...
  bundledCode: "#line 1 \"Math/tests/bigint_mod.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_E\"\
    ...
    \        }\n\n        res.trim();\n        return res / norm;\n    }\n};\n#line\
    \ 5 \"Math/tests/bigint_mod.test.cpp\"\n\nvoid solve() {\n    BigInt a, b; cin\
    \ >> a >> b;\n    cout << a % b << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: Math/tests/bigint_mod.test.cpp
layout: document
redirect_from:
- /verify/Math/tests/bigint_mod.test.cpp
- /verify/Math/tests/bigint_mod.test.cpp.html
