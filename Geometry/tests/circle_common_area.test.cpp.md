...
data:
  ...
  bundledCode: "#line 1 \"Geometry/tests/circle_common_area.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_I\"\n\n//\
    ...
    \ * u.r + u);\n    return res;\n}\n#line 8 \"Geometry/tests/circle_common_area.test.cpp\"\
    \n\n#define ERROR 1e-6\n\nvoid solve() {\n    cout << (fixed) << setprecision(10);\n\
    \    Circle c1, c2; cin >> c1 >> c2;\n    cout << commonCircleArea(c1, c2) <<\
    \ endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: Geometry/tests/circle_common_area.test.cpp
layout: document
redirect_from:
- /verify/Geometry/tests/circle_common_area.test.cpp
- /verify/Geometry/tests/circle_common_area.test.cpp.html
