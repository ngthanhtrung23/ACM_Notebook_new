...
data:
  ...
  bundledCode: "#line 1 \"Graph/tests/maxflow_dinic.test.cpp\"\n#define PROBLEM \"\
    http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_6_A\"\n\n#include\
    ...
    \      if (pushed) {\n                e[id].flow += pushed;\n                e[id^1].flow\
    \ -= pushed;\n                return pushed;\n            }\n        }\n     \
    \   return 0;\n    }\n};\n#line 7 \"Graph/tests/maxflow_dinic.test.cpp\"\n\nint\
  ...
  verifiedWith: []
documentation_of: Graph/tests/maxflow_dinic.test.cpp
layout: document
redirect_from:
- /verify/Graph/tests/maxflow_dinic.test.cpp
- /verify/Graph/tests/maxflow_dinic.test.cpp.html
